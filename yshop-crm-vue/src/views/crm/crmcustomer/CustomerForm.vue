        ...
        <el-col :span="12">
          <el-form-item label="地理位置" prop="city">
            <!-- <el-cascader
              ...
              @change="handleChange"
            /> -->
            <!-- <el-button @click="selectAddr">选择地址</el-button> -->
            <el-input
              v-model="formData.addressStr"
              placeholder="请选择地址"
            >
              <template #append><el-button @click="selectAddr">选择地址</el-button></template>
            </el-input>
          </el-form-item>
        </el-col>
        <el-col :span="12">
...
const handleInput = (event) => {
  //console.log('tagsStr:',tagsStr.value)
  tagsArr.value = tagsStr.value.split(' ')
  //tagsArr.value.push(tagsStr.value.trim())
  //console.log('tagsArr:',tagsArr.value)
...
const getMapAddr = (data) => {
  console.log('data333:',data)
  formData.value.addressStr = data.address

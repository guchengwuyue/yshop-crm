<template>
  <ContentWrap>
    ...
    @select="handleSelect"
  >
      <el-menu-item index="my">我的发票</el-menu-item>
      <el-menu-item index="sub">下属发票</el-menu-item>
    </el-menu>
    <!-- 搜索工作栏 -->
    <el-form
      class="-mb-15px"
      ...
      <el-table-column label="操作" align="center" fixed="right" width="200">
        <template #default="scope">
          <el-button
            link
            type="warning"
            @click="openForm('issue', scope.row.id)"
            v-if="scope.row.checkStatus == 2"
            v-hasPermi="['crm:invoice:issue']"
          >
            开具
          </el-button>
          <el-button
            link
            type="success"
            @click="openForm('log', scope.row.id)"
            v-if="scope.row.isCheck"
            v-hasPermi="['crm:invoice:log']"
          >
            日志
          </el-button>
          <el-button
  ...
  <InvoiceForm3 ref="formRef3" @success="getList" />
...
import InvoiceForm2 from './InvoiceForm2.vue'
import InvoiceForm3 from './InvoiceForm3.vue'

<template>
  ...
  >
    <el-table :data="formData" class="-mt-10px">
      ...
      <!-- </el-table-column> -->
      <el-table-column label="商品属性" min-width="150" prop="sku" />
        <!-- <template #default="{ row, $index }">
      ...
      <el-table-column label="单价" min-width="150" prop="price" />
        <!-- <template #default="{ row, $index }">
      ...
      <el-table-column label="数量" min-width="150" prop="nums" />
        <!-- <template #default="{ row, $index }">
      ...
      <el-table-column label="小计" min-width="150" prop="subtotal" />
        <!-- <template #default="{ row, $index }">

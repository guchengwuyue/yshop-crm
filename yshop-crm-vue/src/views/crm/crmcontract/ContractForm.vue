    ...
    <el-row>
      ...
      <el-tabs v-model="subTabsName">
        <el-tab-pane label="合同产品关系" name="contractProduct">
          <ContractProductForm ref="contractProductFormRef"  @get-new-data="getNewData" :business-id="formData.businessId" :contract-id="formData.id" />
        </el-tab-pane>
      </el-tabs>
      <el-row style="margin-top:50px">
        ...
        <el-col :span="8">
          <el-form-item label="产品总金额" prop="totalPrice">
            <el-input v-model="formData.totalPrice" readonly placeholder="请输入产品总金额" />
          </el-form-item>
        </el-col>
      </el-row>
...
const open = async (type: string, id?: number) => {
  ...
  if (id) {
    ...
    console.log('flowAdminsId:',flowAdminsId)
